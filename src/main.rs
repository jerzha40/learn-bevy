use bevy::prelude::{
    App, Camera2d, Color, Commands, Component, DefaultPlugins, Query, Res, Sprite, Startup, Time,
    Transform, Update, Vec2, Window, With, default,
};
...
fn main() {
    App::new()
        ...
        .add_systems(Update, (move_player, bounce_in_window))
        .run();
}
