...
/// Spawn a tank prefab
///
/// - returns the tank entity (Tank + TankBody + Sprite)
/// - turret and barrel are children so they can rotate independently later
            ...
            .with_children(|turret| {
                turret.spawn((
                    ...
                    SpriteBundle {
                        ...
                        transform: Transform::from_translation(Vec3::new(0.0, turret_size.y * 0.55, 1.0)),
                        ..default()
                    },
                ));
            });
